...
function TaoUserRegistration({ open, setOpen, isProfile }) {
  ...
  useEffect(() => {
    if (isProfile == 1) {
      setExpanded("panel2");
      dispatch(searchTaoUserAction({ roleCode: "TAOUSER", isActive }));
    }
  }, []);
  useEffect(() => {
    if (true == createData) {
  ...
  const handleSearch = () => {
    ...
    dispatch(searchTaoUserAction(searchData));
  };
    ...
    <>
      ...
      >
        ...
        >
          <Typography>
            {viewMode
              ? "View TAO User Registration"
              : editingTaoUserData
              ? "Edit TAO User Registration"
              : "Create TAO User Registration"}
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
                  ...
                  {!viewMode ? (
                    <div className="col-md-12">
                      <div className="BtnGroup">
                        ...
                        >
                          {editingTaoUserData ? "Update" : "Submit"}
                        </button>
                        <button
                          className="Clear"
                          disabled={viewMode}
